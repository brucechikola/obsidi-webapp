...
const Card = ({content}) =>{
    ...
    return (
      <motion.div 
        ...
        viewport={{ once: true }}
        className={`w-full rounded-xl bg-white p-8 relative border border-${content?.is_frequent ? "black/80 border-3 h-[569px]" : "slate-400 h-[545px]"}`}>
...
export default function Pricing() {
  ...
  return (
    <div className="w-full lg:h-[890px] bg-[#f9f6ff] relative pb-15 lg:pb-0">
        <img src={star} alt="" className="absolute mix-blend-color-burn w-[80%] lg:w-[50%] lg:h-[525px] object-contain" />
        ...
        <div className="relative w-full h-full flex items-center justify-center flex-col">
          <h3 className="font-semibold text-[30px] md:text-[35px] lg:text-[45px]">Pricing</h3>
          <p className="my-4 w-[80%] lg:w-[60%] text-center text-slate-600">
          ...
          <div className="w-[90%] lg:w-[75%] lg:h-[545px] grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-8 mt-5">
            {
