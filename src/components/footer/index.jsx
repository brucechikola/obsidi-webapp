...
export default function Footer() {
  return (
    <div className="w-full pt-14 pb-10">
        <div className="w-[85%] grid grid-cols-6 gap-x-4 mx-auto">
        ...
        <div className="w-[85%] border-t border-slate-200 mx-auto mt-1 grid grid-cols-6 gap-x-4 pt-2">
            ...
            <div className="w-[80%] flex col-span-2 items-center justify-around gap-y-4 ">
                <FooterLink url="#" title="Terms and Conditions"/>
                <FooterLink url="#" title="Privacy Policy"/>
            </div>
        </div>
