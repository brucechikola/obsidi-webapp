...
const FooterLink = ({title, url}) =>{
    return <a href={url} target="_blank" className="text-[13px] text-slate-500 hover:text-blue-600">{title}</a>
}
export default function Footer() {
  return (
    <div className="w-full pt-14 pb-10">
        <div className="w-[90%] lg:w-[85%] xl:w-[80%] grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-4 mx-auto">
            <div className="w-full col-span-2 mb-8 lg:mb-0">
                <Logo className="w-[160px]"/>
                <p className="text-slate-600 my-3 text-[12px]">Stay in touch</p>
                <div className="grid grid-cols-5 w-full md:w-[70%] lg:w-[50%]">
            ...
            <div className="w-full flex flex-col gap-y-4 mt-4 lg:mt-0">
        ...
        <div className="w-[90%] lg:w-[85%] border-t border-slate-200 mx-auto mt-1 grid grid-cols-6 gap-x-4 pt-2">
            <div className="col-span-6 lg:col-span-3">
                <span className="text-[12px] text-slate-600">©2025 All rights reserved to Obsidi® and BPTN.</span>
            </div>
            <div className="w-full flex flex-col gap-y-4 col-span-3 mt-5 lg:col-span-1 lg:mt-0">
                <FooterLink url="#" title="BFUTR SUMMIT"/>
                <FooterLink url="#" title="Obsidi® BNXT"/>
            </div>
            <div className="w-full lg:w-[80%] flex col-span-3 mt-5 flex-col lg:flex-row lg:col-span-1 lg:mt-0 lg:col-span-2 lg:items-center justify-around gap-y-4 ">
                <FooterLink url="#" title="Terms and Conditions"/>
                <FooterLink url="#" title="Privacy Policy"/>
            </div>
        </div>
